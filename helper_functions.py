...
class Helper():
    ...
    def handle_axis(self,
                    axis: matplotlib.pyplot.axis | np.ndarray[matplotlib.pyplot.axis],
                    title: str | List[str]=None,
                    grid: bool | List[bool]=False,
                    legend: bool=False,
                    legend_loc: int=0,
                    ...
                    font_size: int=False,
                    line_width: int=None,
                    label_pad: float=5) -> matplotlib.pyplot.axis | np.ndarray[matplotlib.pyplot.axis]:
        """
